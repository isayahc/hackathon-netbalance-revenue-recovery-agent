...
import svgPaths from "./svg-9vxqjczua8";
...
function Frame15() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-center leading-[normal] not-italic relative shrink-0 w-full whitespace-nowrap" data-name="Frame">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[#4b5563] text-[18px]">$1,200.00 sent to Priya Sharma</p>
    </div>
  );
}
...
function BtnSecondary1() {
  return (
    <a className="content-stretch cursor-pointer flex flex-[1_0_0] h-[48px] items-center justify-center min-w-px relative rounded-[100px]" data-name="btn-secondary">
      <div aria-hidden className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#111827] text-[14px] text-left whitespace-nowrap">View payout</p>
    </a>
  );
}
...
function BtnPrimary() {
  return (
    <a className="bg-[#1d568d] content-stretch cursor-pointer flex flex-[1_0_0] h-[48px] items-center justify-center min-w-px relative rounded-[100px]" data-name="btn-primary">
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[14px] text-left text-white whitespace-nowrap">Create another payout</p>
    </a>
  );
}
...
function BtnSecondary2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[48px] items-center justify-center min-w-px relative rounded-[8px]" data-name="btn-secondary">
      <a className="[word-break:break-word] block cursor-pointer font-['Inter:Bold',sans-serif] font-bold leading-[0] not-italic relative shrink-0 text-[#4b5768] text-[14px] whitespace-nowrap">
        <p className="[text-underline-position:from-font] decoration-from-font decoration-solid leading-[normal] underline">Go to dashboard</p>
      </a>
    </div>
  );
}
