...
import svgPaths from "./svg-f7u58lx2id";
...
function Frame35() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start opacity-60 relative shrink-0 w-full" data-name="Frame">
...
function Frame42() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start leading-[normal] min-w-px not-italic relative whitespace-nowrap" data-name="Frame">
      <p className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0 text-[14px] text-black">Priya Sharma</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[#4b5563] text-[12px]">India • Bank Transfer</p>
    </div>
  );
}
...
function Frame40() {
  return (
    <motion.div className="bg-[#f9fafb] relative rounded-[12px] shrink-0 w-full" data-name="Frame">
      <div aria-hidden className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center p-[16px] relative size-full">
          <Frame41 />
          <Frame42 />
          <p className="[word-break:break-word] font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[normal] not-italic relative shrink-0 text-[16px] text-black whitespace-nowrap">$12,500.00</p>
        </div>
      </div>
    </motion.div>
  );
...
function Frame43() {
  return (
    <motion.div className="bg-[#fef3c7] content-stretch flex gap-[12px] items-start p-[12px] relative rounded-[8px] shrink-0" data-name="Frame">
      <div className="relative shrink-0 size-[16px]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
          <path d={svgPaths.p23de6480} id="Vector" stroke="var(--stroke-0, #F59E0B)" strokeWidth="2" />
        </svg>
      </div>
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[#92400e] text-[13px] w-[312px]">Payouts over $10,000 require manual confirmation.</p>
    </motion.div>
  );
}
...
function Frame45() {
  return (
    <div className="bg-white h-[44px] relative rounded-[8px] shrink-0 w-full" data-name="Frame">
      <div aria-hidden className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#9ca3af] text-[14px] whitespace-nowrap">$12,500.00</p>
        </div>
      </div>
    </div>
  );
...
function Frame44() {
  return (
    <motion.div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#374151] text-[13px] whitespace-nowrap">Type the exact amount to confirm</p>
      <Frame45 />
    </motion.div>
  );
}
...
function Frame47() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-[44px] items-center justify-center min-w-px relative rounded-[100px]" data-name="Frame">
      <div aria-hidden className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-black whitespace-nowrap">Cancel</p>
    </div>
  );
}
...
function Frame48() {
  return (
    <div className="bg-[#1d568d] content-stretch flex flex-[1_0_0] h-[44px] items-center justify-center min-w-px opacity-30 relative rounded-[100px]" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">{`Confirm & Send`}</p>
    </div>
  );
}
...
function Frame46() {
  return (
    <motion.div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full" data-name="Frame">
      <Frame47 />
      <Frame48 />
    </motion.div>
  );
...
function Frame39() {
  return (
    <motion.div className="absolute bg-white content-stretch drop-shadow-[0px_20px_20px_rgba(0,0,0,0.2)] flex flex-col gap-[24px] items-start left-1/2 p-[32px] rounded-[16px] top-1/2 w-[440px]" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[20px] text-black whitespace-nowrap">Confirm high-value payout</p>
      <Frame40 />
      <Frame43 />
      <Frame44 />
      <Frame46 />
...
export default function HighValueConfirmationModal() {
  return (
    <div className="bg-[#f8f9fa] content-stretch flex flex-col items-start relative size-full" data-name="high-value-confirmation-modal">
      <TopBar />
      <Frame />
      <motion.div className="absolute bg-[rgba(0,0,0,0.3)] h-[982px] left-0 top-0 w-[1512px]" data-name="Rectangle" />
      <Frame39 />
    </div>
  );
}