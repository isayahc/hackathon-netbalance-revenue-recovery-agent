...
import svgPaths from "./svg-yz935bswue";
...
function BtnReject() {
  return (
    <a className="bg-[#1a2332] cursor-pointer relative rounded-[100px] shrink-0 w-full" data-name="btn-reject">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center p-[12px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-left text-white whitespace-nowrap">Reject</p>
        </div>
      </div>
    </a>
  );
...
function BtnHold() {
  return (
    <a className="cursor-pointer relative rounded-[100px] shrink-0 w-full" data-name="btn-hold">
      <div aria-hidden className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[100px]" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center p-[12px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#374151] text-[14px] text-left whitespace-nowrap">Hold</p>
        </div>
      </div>
    </a>
  );
