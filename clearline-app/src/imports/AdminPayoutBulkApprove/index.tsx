...
import svgPaths from "./svg-4jtsweyawo";
...
function BulkApprove() {
  return (
    <a className="bg-[#eef4ff] content-stretch cursor-pointer flex items-center justify-center px-[24px] py-[12px] relative rounded-[100px] shrink-0 w-[134px]" data-name="bulk-approve">
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#1d568d] text-[15px] text-left whitespace-nowrap">New Payout</p>
    </a>
  );
}
